...
type TestService_EnrollStudentsClient interface {
	...
	CloseAndRecv() (*SetEnrollmentResponse, error)
	grpc.ClientStream
}
...
func (x *testServiceEnrollStudentsClient) CloseAndRecv() (*SetEnrollmentResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(SetEnrollmentResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type TestService_EnrollStudentsServer interface {
	SendAndClose(*SetEnrollmentResponse) error
...
func (x *testServiceEnrollStudentsServer) SendAndClose(m *SetEnrollmentResponse) error {
	return x.ServerStream.SendMsg(m)
}
