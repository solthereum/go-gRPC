...
import (
	studentpb "github.com/Thrashy190/go/grpc/studentpb"
...
func (x *SetEnrollmentResponse) Reset() {
	*x = SetEnrollmentResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetEnrollmentResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetEnrollmentResponse) ProtoMessage() {}

func (x *SetEnrollmentResponse) ProtoReflect() protoreflect.Message {
	mi := &file_testpb_test_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetEnrollmentResponse.ProtoReflect.Descriptor instead.
func (*SetEnrollmentResponse) Descriptor() ([]byte, []int) {
	return file_testpb_test_proto_rawDescGZIP(), []int{7}
}

func (x *SetEnrollmentResponse) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
var file_testpb_test_proto_rawDesc = []byte{
	...
	0x6c, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07,
	...
	0x6e, 0x74, 0x49, 0x64, 0x22, 0x34, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65,
	...
	0x28, 0x09, 0x52, 0x06, 0x74, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0x27, 0x0a, 0x15, 0x53, 0x65,
	...
	0x02, 0x6f, 0x6b, 0x32, 0xba, 0x02, 0x0a, 0x0b, 0x54, 0x65, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76,
	...
	,
	...
	0x68, 0x72, 0x61, 0x73, 0x68, 0x79, 0x31, 0x39, 0x30, 0x2f, 0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70,
...
var file_testpb_test_proto_goTypes = []interface{}{
	...
	(*SetEnrollmentResponse)(nil),     // 7: test.SetEnrollmentResponse
...
var file_testpb_test_proto_depIdxs = []int32{
	...
	7, // 8: test.TestService.EnrollStudents:output_type -> test.SetEnrollmentResponse
...
func file_testpb_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_testpb_test_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetEnrollmentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
